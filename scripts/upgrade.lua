...
local title ={
	none   = 'Tranquilo Codicioso!',
	white  = 'La Banda del Santo',
	yellow = 'Banda Soleada',
	green = 'Banda flotadora',
	blue = 'La Banda de Blue Demon',
	red = 'Banda de la Sangre',
}

local explanation = {
	none   = '\n\n\n\n\n\n\n\n\n\nYa tienes esta banda.\nMejor comete este arroz!...or un buen perche',
	white  = '\n\n\n\n\n\n\n\n\n\nComo aprendiste del Maestro Coshi! Salta mas alto, corre como Naruto!',
	yellow = '\n\n\n\n\n\n\n\n\n\nAhora puedes saltar por los muros!',
	green = '\n\n\n\n\n\n\n\n\n\nUsa tu banda como paracaidas...no preguntes como funciona.',
	blue = '\n\n\n\n\n\n\n\n\n\nComo todo ninja, aplica la woosh.',
	red = '\n\n\n\n\n\n\n\n\n\nAh mira...ahora te crees Link....',
}
