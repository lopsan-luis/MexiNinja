...
function menu:init()
	...
	creditsMenu:addText( 'Giovanni Lopez', -50, -52, 40 ,nil,'left',colors.blueText)
	creditsMenu:addText( 'Giovanni Lopez', -95, -20, 40 ,nil,'right',colors.blueText)
	creditsMenu:addText( 'Giovanni Lopez ', -50, 12, 40 ,nil,'left',colors.blueText)
	creditsMenu:addText( 'Giovanni Lopez', 58, -52, 40 ,nil,'left',colors.blueText)
	creditsMenu:addText( 'Giovanni Lopez', 3, -20, 40 ,nil,'right',colors.blueText)
